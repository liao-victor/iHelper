...
$strSQL = "call UPDATE_PEOPLE.ISUPERVISOR('$aid','$fname','$lname','$pn','$em','$midd')";
...
<input type="button" name="Go Back" value="Back" onclick="location.href='pi_supe_show.php'">
</body>
</html>