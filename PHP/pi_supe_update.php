...
<body>
    ...
    $idd = $_GET["CusID"];
    $strSQL = "BEGIN VIEW_PEOPLE.VIEW_SUPE_DETAIL('$idd',:refcur); END;";
    ...
    if(!$objResult)
    {
        echo "Not found SupervisorID=".$_GET["CusID"];
    }
    else
    {

        ?>
    <form  action="pi_supe_exct.php?CusID=<?=$objResult["PersonID"];?>"  name="frmEdit" method="post">
        <table width="600" border="1">
            <tr>
                ...
                <th width="98"> <div align="center">Department <br>ID </div></th>
            </tr>
            <tr>
                ...
                <td><input type="number" min="0" max="26" name="txtDeptID" size="5"  value="<?=$objResult["DeptID"];?>" required></td>
            </tr>
        </table>
        <table width="600" border="1">
            <tr>
