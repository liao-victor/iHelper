...
if (!isset($_SESSION['curUser'])) {
    ...
    include("interdetail_ui.inc");
    include("myjob_cn.inc");
    include("interdetail_db.inc");
    ...
    $table_ref = db_get_table($conn,$_GET['appid'],$_GET['jobid']);

    ui_print_header('Interview Details', $_SESSION['curUser']);
