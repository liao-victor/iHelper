...
if (!isset($_SESSION['curUser'])) {
    ...
    if (!isset($_GET["inid"]))
        ...
        try {
            $stmt = "BEGIN destroy.dInterview(" . $_GET["inid"] . "); END;";
        ...
        print '<br><button type="button" onclick="window.location.href=\'inter_session.php?id=' . $_GET["id"] . '&jobid=' . $_GET["jobid"] . '\'">GO BACK</button>';
